  ...
  return (
    <RedirectByRole>
      <main className="relative min-h-screen overflow-hidden bg-background px-6 py-10 text-foreground">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.86),rgba(248,250,252,0.98))] dark:bg-[radial-gradient(circle_at_top,rgba(110,168,255,0.14),transparent_30%),linear-gradient(180deg,rgba(5,8,22,0.98),rgba(3,7,18,1))]" />
