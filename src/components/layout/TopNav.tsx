...
export function TopNav({ compactGap = false }: { compactGap?: boolean }) {
  ...
  return (
    ...
    >
      <div className="rounded-lg border border-border bg-card px-4 py-3 shadow-sm dark:border-border/70 dark:bg-background/70 dark:shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_48px_rgba(0,0,0,0.24)] dark:backdrop-blur-xl">
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs text-muted-foreground dark:text-cyan-200/70">Job Portal</div>
